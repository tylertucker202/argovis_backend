...
var ProfileSchema = Schema(
  {
    ...
    measurements: [{ pres: {type: Number, required: true},
                     ...
                     temp_qc: {type: String, required: true},
                     psal: {type: Number, required: true},
                     psal_qc: {type: String, required: true}, 
                     cndc: {type: Number, required: false},
                     cndc_qc: {type: String, required: false},
                     doxy: {type: Number, required: false},
                     doxy_qc: {type: String, required: false}, 
                     chla: {type: Number, required: false},
                     chla_qc: {type: String, required: false}, 
                     cdom: {type: Number, required: false},
                     cdom_qc: {type: String, required: false}, 
                     nitrate: {type: Number, required: false},
                     nitrate_qc: {type: String, required: false}, 
                     }],
